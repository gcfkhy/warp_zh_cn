...
fn get_shell_debug_enable_name() -> String {
    tr!("menu-debug-enable-shell-debug-mode")
}
fn get_shell_debug_disable_name() -> String {
    tr!("menu-debug-disable-shell-debug-mode")
}
fn get_in_band_generators_enable_name() -> String {
    tr!("menu-debug-enable-in-band-generators")
}
fn get_in_band_generators_disable_name() -> String {
    tr!("menu-debug-disable-in-band-generators")
}
fn get_pty_recording_enable_name() -> String {
    tr!("menu-debug-enable-pty-recording")
}
fn get_pty_recording_disable_name() -> String {
    tr!("menu-debug-disable-pty-recording")
}
fn get_bootstrap_block_show_name() -> String {
    tr!("menu-debug-show-bootstrap-block")
}
fn get_bootstrap_block_hide_name() -> String {
    tr!("menu-debug-hide-bootstrap-block")
}
fn get_in_band_command_blocks_show_name() -> String {
    tr!("menu-debug-show-in-band-command-blocks")
}
fn get_in_band_command_blocks_hide_name() -> String {
    tr!("menu-debug-hide-in-band-command-blocks")
}
fn get_ssh_command_blocks_show_name() -> String {
    tr!("menu-debug-show-ssh-command-blocks")
}
fn get_ssh_command_blocks_hide_name() -> String {
    tr!("menu-debug-hide-ssh-command-blocks")
}
fn get_export_default_settings_csv_name() -> String {
    tr!("menu-debug-export-default-settings-csv")
}
...
fn default_name(action: CustomAction, ctx: &AppContext) -> String {
    ctx.description_for_custom_action(action.into(), bindings::MAC_MENUS_CONTEXT)
        .unwrap_or_else(|| {
            ...
            tr!("menu-fallback-no-description")
        })
}
...
fn make_new_app_menu(ctx: &AppContext) -> Menu {
    ...
    menu_items.push(MenuItem::Custom(CustomMenuItem::new(
        &tr!("menu-app-set-warp-as-default-terminal"),
        move |ctx| {
    ...
    Menu::new(&tr!("menu-warp"), menu_items)
}
...
fn make_new_file_menu(ctx: &AppContext) -> Menu {
    ...
    Menu::new(&tr!("menu-file"), file_menu_options)
}
...
fn make_new_edit_menu(ctx: &AppContext) -> Menu {
    ...
    let group_5 = vec![
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-edit-copy-on-select-within-the-terminal"),
            move |ctx| {
    ...
    edit_menu_items.push(MenuItem::Custom(CustomMenuItem::new_with_submenu(
        &tr!("menu-edit-synchronize-inputs"),
        |_| (),
        no_updates,
        None,
        vec![
    ...
    Menu::new(&tr!("menu-edit"), edit_menu_items)
}
...
fn make_new_view_menu(ctx: &AppContext) -> Menu {
    let mut items = vec![
        ...
        MenuItem::Separator,
        MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-view-toggle-mouse-reporting"),
            move |ctx| {
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-view-toggle-scroll-reporting"),
            move |ctx| {
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-view-toggle-focus-reporting"),
            move |ctx| {
    ...
    if FeatureFlag::DebugMode.is_enabled() {
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            ...
            move |_props, ctx| {
                ...
                {
                    get_pty_recording_disable_name()
                } else {
                    get_pty_recording_enable_name()
                };
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &get_in_band_generators_enable_name(),
            move |ctx| {
                DebugSettings::handle(ctx).update(ctx, |debug_settings, ctx| {
            ...
            move |_props, ctx| {
                let name = if DebugSettings::handle(ctx).read(ctx, |settings, _ctx| {
                    *settings
                    ...
                    get_in_band_generators_disable_name()
                } else {
                    get_in_band_generators_enable_name()
                };
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-debug-manually-toggle-network-status"),
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &get_export_default_settings_csv_name(),
            move |ctx| {
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-debug-create-anonymous-user"),
...
fn make_new_help_menu() -> Menu {
    Menu::new(
        ...
        vec![
            feedback_menu_item(),
            link_menu_item(tr!("menu-help-warp-documentation"), links::USER_DOCS_URL.into()),
            link_menu_item(tr!("menu-help-github-issues"), links::GITHUB_ISSUES_URL.into()),
            link_menu_item(tr!("menu-help-warp-slack-community"), links::SLACK_URL.into()),
        ],
    )
}
...
fn make_new_elements_menu_items(ctx: &AppContext) -> Vec<MenuItem> {
    ...
    let mut new_elements_menu = vec![
        MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-file-new-window"),
            open_new_window,
            no_updates,
            Some(Keystroke::parse("cmd-n").expect("Valid keystroke")),
        )),
        MenuItem::Custom(CustomMenuItem::new(
            &tr!("menu-file-new-terminal-tab"),
    ...
    new_elements_menu.push(MenuItem::Custom(CustomMenuItem::new(
        &tr!("menu-file-reopen-closed-session"),
        |ctx| {
    ...
    new_elements_menu.push(MenuItem::Custom(CustomMenuItem::new_with_submenu(
        &tr!("menu-file-launch-configurations"),
        |_| (),
