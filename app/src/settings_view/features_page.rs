...
cfg_if::cfg_if! {
    if #[cfg(target_os = "macos")] {
        fn extra_meta_keys_left_text() -> String { tr!("settings-features-meta-left-option") }
        fn extra_meta_keys_right_text() -> String { tr!("settings-features-meta-right-option") }
    } else {
        fn extra_meta_keys_left_text() -> String { tr!("settings-features-meta-left-alt") }
        fn extra_meta_keys_right_text() -> String { tr!("settings-features-meta-right-alt") }
    }
}
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let mut toggle_binding_pairs = vec![
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-copy-on-select"),
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-linux-selection-clipboard"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-autocomplete-symbols"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-restore-session"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-scroll-reporting"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-completions-while-typing"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-command-corrections"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-error-underlining"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-syntax-highlighting"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-audible-bell"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-autosuggestions"),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-autosuggestion-keybinding-hint"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    if !FeatureFlag::SSHTmuxWrapper.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-ssh-wrapper"),
            builder(SettingsAction::FeaturesPageToggle(
                #[allow(deprecated)]
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        &tr!("settings-features-toggle-link-tooltip"),
        builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-quit-warning-modal"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-alias-expansion"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-middle-click-paste"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-code-default-editor"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-input-hint-text"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-vim-mode"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-vim-unnamed-clipboard"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-vim-status-bar"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-focus-reporting"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        &tr!("settings-features-toggle-smart-select"),
        builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr!("settings-features-toggle-terminal-input-message-line"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    if FeatureFlag::AgentView.is_enabled() && AISettings::as_ref(app).is_any_ai_enabled(app) {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                &tr!("settings-features-toggle-slash-commands-terminal"),
                builder(SettingsAction::FeaturesPageToggle(
    ...
    if GPUState::as_ref(app).is_low_power_gpu_available() {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                &tr!("settings-features-toggle-integrated-gpu"),
                builder(SettingsAction::FeaturesPageToggle(
    ...
    #[cfg(any(target_os = "linux", target_os = "freebsd"))]
    {
        if windowing_system_is_customizable(app) {
            toggle_binding_pairs.push(
                ToggleSettingActionPair::new(
                    &tr!("settings-features-toggle-wayland"),
                    builder(SettingsAction::FeaturesPageToggle(
    ...
    app.register_fixed_bindings([FixedBinding::empty(
        &tr!("settings-features-configure-global-hotkey"),
    ...
    if DefaultTerminal::can_warp_become_default() {
        app.register_fixed_bindings([FixedBinding::empty(
            &tr!("settings-features-make-warp-default-terminal-cmd"),
            builder(SettingsAction::FeaturesPageToggle(
...
fn block_maximum_rows_description() -> String {
    ...
    tr!("settings-features-block-maximum-rows-description", max_rows = max_rows)
}
...
impl FeaturesPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        let categories = vec![
            Category::new(tr!("settings-features-category-general"), general_widgets),
            Category::new(tr!("settings-features-category-session"), session_widgets),
            Category::new(tr!("settings-features-category-keys"), keys_widgets),
            Category::new(tr!("settings-features-category-text-editing"), text_editing_widgets),
            Category::new(tr!("settings-features-category-terminal-input"), editor_widgets),
            Category::new(tr!("settings-features-category-terminal"), terminal_widgets),
            Category::new(tr!("settings-features-category-notifications"), notifications_widgets),
            Category::new(
                tr!("settings-features-category-workflows"),
                vec![Box::new(WorkflowsInCommandSearch::default())],
            ),
            Category::new(tr!("settings-features-category-system"), system_widgets),
        ];
        ...
        self.graphics_backend_dropdown.update(ctx, |dropdown, ctx| {
            if let Some(window) = ctx.windows().platform_window(ctx.window_id()) {
                let mut items = vec![DropdownItem::new(
                    tr!("settings-features-graphics-backend-default"),
            ...
            dropdown.set_selected_by_name(
                gpu_settings
                    ...
                    .unwrap_or(&tr!("settings-features-graphics-backend-default")),
                ctx,
            );
        });
    }
    ...
    fn new_tab_placement_dropdown_item_label(val: NewTabPlacement) -> String {
        match val {
            NewTabPlacement::AfterAllTabs => tr!("settings-features-new-tab-placement-after-all"),
            NewTabPlacement::AfterCurrentTab => tr!("settings-features-new-tab-placement-after-current"),
        }
    }
                ...
                Container::new(
                    Flex::row()
                        .with_child(
                            Container::new(
                                Text::new_inline(
                                    &tr!("settings-features-quake-width-percent"),
                ...
                Container::new(
                    Flex::row()
                        .with_child(
                            Container::new(
                                Text::new_inline(
                                    &tr!("settings-features-quake-height-percent"),
                                    appearance.ui_font_family(),
                                    appearance.ui_font_size(),
                                )
                                .with_color(theme.active_ui_text_color().into())
        ...
        Container::new(
            Flex::row()
                ...
                .with_child(
                    appearance
                        .ui_builder()
                        .span(tr!("settings-features-quake-autohides-on-loss-focus"))
                        .build()
                        .with_margin_left(5.)
                        .finish(),
                )
        ...
        Flex::row()
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            &tr!("settings-features-notifications-long-running-prefix"),
                            appearance.ui_font_family(),
                            font_size,
                        )
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            &tr!("settings-features-notifications-seconds-to-complete"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
            ...
            Flex::row()
                ...
                .with_child(
                    Shrinkable::new(
                        2.,
                        Align::new(
                            Text::new_inline(&tr!("settings-features-keybinding-label"), appearance.ui_font_family(), 13.)
                ...
                .with_child(
                    Shrinkable::new(
                        ...
                        Align::new(if let Some(keybinding) = &keybinding.unsaved_binding {
                            ...
                            appearance
                                .ui_builder()
                                .paragraph(tr!("settings-features-click-to-set-global-hotkey"))
                                .build()
                                .finish()
                        })
                        .finish(),
    ...
    fn render_clicked<T: Fn(&mut EventContext, Keystroke) + 'static>(
        ...
        let cancel_button = appearance
            ...
            .with_text_label(tr!("settings-features-cancel"))
            .build()
            .on_click(move |ctx, _, _| {
        ...
        let save_button = Shrinkable::new(
            ...
            appearance
                ...
                .with_text_label(tr!("settings-features-save"))
                .build()
                .on_click(move |ctx, _, _| {
                    ...
                    Flex::row()
                        .with_child(
                            Shrinkable::new(
                                ...
                                Align::new(
                                    Text::new_inline(
                                        &tr!("settings-features-press-new-keyboard-shortcut"),
                                        appearance.ui_font_family(),
                                        13.,
                                    )
                                    .with_color(appearance.theme().active_ui_text_color().into())
    ...
    fn render_change_keybinding_button(
        ...
        Hoverable::new(
            ...
            |state| {
                ...
                Container::new(
                    Text::new_inline(&tr!("settings-features-change-keybinding"), appearance.ui_font_family(), 12.)
...
fn init_display_count_dropdown(
    ...
    let no_preference = DropdownItem::new(
        tr!("settings-features-quake-active-screen"),
        //|| {
    ...
    match quake_mode_settings.pin_screen {
        ...
        _ => dropdown.set_selected_by_name(&tr!("settings-features-quake-active-screen"), ctx),
    };
}
...
impl SettingsWidget for NativeRedirectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-open-links-in-desktop-app"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(
                    tr!("settings-features-open-links-in-desktop-app-tooltip"),
                ),
            }),
...
impl SettingsWidget for SessionRestorationWidget {
    ...
    fn render(
        ...
        let labeled_switch = render_body_item::<FeaturesPageAction>(
            tr!("settings-features-restore-session"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
        ...
        if app.is_wayland() {
            let message = Text::new_inline(
                &tr!("settings-features-restore-session-wayland-warning"),
                appearance.ui_font_family(),
                CONTENT_FONT_SIZE,
            )
...
impl SettingsWidget for SnackbarHeaderWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-sticky-command-header"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for LinkTooltipWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-tooltip-on-links"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWarningModalWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-warning-before-quitting"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for LoginItemWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        #[cfg(target_os = "macos")]
        let label = tr!("settings-features-start-warp-at-login-macos");
        #[cfg(not(target_os = "macos"))]
        let label = tr!("settings-features-start-warp-at-login");
        render_body_item::<FeaturesPageAction>(
            label.into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWhenAllWindowsClosedWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-quit-when-all-windows-closed"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowChangelogWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-changelog-after-updates"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MouseScrollMultiplierWidget {
    ...
    fn render(
        ...
        let input_column = Flex::column()
            .with_children([
                ...
                if view.valid_mouse_scroll_multiplier {
                    ...
                    appearance
                        .ui_builder()
                        .wrappable_text(&tr!("settings-features-mouse-scroll-allowed-values"), true)
                        .with_style(UiComponentStyles {
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-mouse-scroll-multiplier-label"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(
                    tr!("settings-features-mouse-scroll-multiplier-tooltip"),
                ),
            }),
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutoOpenCodeReviewPaneWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-auto-open-code-review-panel"),
            None,
            LocalOnlyIconState::for_setting(
            ...
            ui_builder
                ...
                .finish(),
            Some(tr!("settings-features-auto-open-code-review-panel-description")),
        )
    }
}
...
impl SettingsWidget for DefaultTerminalWidget {
    ...
    fn render(
        ...
        if default_terminal.is_warp_default() {
            ui_builder
                .wrappable_text(&tr!("settings-features-warp-is-default-terminal"), true)
                .with_style(UiComponentStyles {
            ...
            ui_builder
                .link(
                    tr!("settings-features-make-warp-default-terminal"),
                    None,
                    Some(Box::new(|ctx| {
...
impl SettingsWidget for BlockLimitWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-maximum-rows-in-block"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SSHWrapperWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-warp-ssh-wrapper"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                ...
                secondary_text: if view.ssh_wrapper_toggled {
                    Some(tr!("settings-features-change-takes-effect-new-sessions"))
                } else {
                    None
                },
                tooltip_override_text: None,
...
impl SettingsWidget for DesktopNotificationsWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            tr!("settings-features-receive-desktop-notifications"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
            ...
            let toggles = vec![
                view.render_notification_toggle(
                    session_settings
                        .notifications
                        .is_agent_task_completed_enabled,
                    &tr!("settings-features-notify-agent-task-completed"),
                ...
                view.render_notification_toggle(
                    ...
                    &tr!("settings-features-notify-needs-attention"),
                ...
                #[cfg(target_os = "macos")]
                {
                    view.render_notification_toggle(
                        ...
                        &tr!("settings-features-play-notification-sounds"),
        ...
        if FeatureFlag::HOANotifications.is_enabled() {
            ...
            column.add_child(render_body_item::<FeaturesPageAction>(
                tr!("settings-features-show-in-app-agent-notifications"),
                None,
            ...
            if show_agent_notifications {
                ...
                let toast_duration_row = Flex::row()
                    ...
                    .with_child(
                        Text::new_inline(
                            &tr!("settings-features-toast-notifications-stay-visible"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
                    ...
                    .with_child(
                        Text::new_inline(&tr!("settings-features-seconds"), appearance.ui_font_family(), font_size)
                            .with_color(font_color.into())
                            .finish(),
                    )
                    .finish();
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    tr!("settings-features-default-shell-for-new-sessions"),
    ...
    fn render(
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    tr!("settings-features-working-directory-for-new-sessions"),
                    Some(LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ConfirmCloseSharedSessionWidget {
    ...
    fn render(
        ...
        let session_settings = SessionSettings::as_ref(app);
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-confirm-close-shared-session"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for GlobalHotkeyWidget {
    ...
    fn render(
        ...
        if app.is_wayland() {
            column.add_child(render_body_item::<FeaturesPageAction>(
                tr!("settings-features-global-hotkey"),
                None,
                ...
                Flex::row()
                    .with_children([
                        ui_builder
                            .span(&tr!("settings-features-global-hotkey-not-supported-wayland"))
                            .build()
                            .finish(),
                        ui_builder
                            .link(
...
impl SettingsWidget for AutocompleteSymbolsWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-autocomplete-symbols"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ErrorUnderliningWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-error-underlining"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SyntaxHighlightingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-syntax-highlighting"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CompletionsMenuWhileTypingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-completions-while-typing"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CommandCorrectionsWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-suggest-corrected-commands"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AliasExpansionWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-expand-aliases"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MiddleClickPasteWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-middle-click-paste"),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render(
        ...
        if vim_mode_enabled {
            ...
            let clipboard_setting = view.render_setting_subgroup_item(
                ...
                clipboard_switch,
                tr!("settings-features-vim-unnamed-register-clipboard"),
            );
            ...
            let status_bar_setting = view.render_setting_subgroup_item(
                ...
                status_bar_switch,
                tr!("settings-features-vim-status-bar"),
            );
...
impl SettingsWidget for AtContextMenuInTerminalModeWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-at-context-menu-terminal-mode"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SlashCommandsInTerminalModeWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-slash-commands-terminal-mode"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for OutlineCodebaseSymbolsForAtContextMenuWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-outline-codebase-symbols"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowTerminalInputMessageLineWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-terminal-input-message-line"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutosuggestionKeybindingHintWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-autosuggestion-keybinding-hint"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutosuggestionIgnoreButtonWidget {
    ...
    fn render(
        ...
        let show_autosuggestion_ignore_button = *app_editor_settings
            ...
            .value();
        column.add_child(render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-autosuggestion-ignore-button"),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render_tab_behavior_setting_secondary_row(
        ...
        let other_keybinding_info = match *view.tab_behavior {
            TabBehavior::Completions if view.autosuggestions_keystroke.is_empty() => {
                ...
                Some(tr!("settings-features-tab-right-arrow-accepts-autosuggestions"))
            }
            TabBehavior::Completions => Some(tr!(
                "settings-features-tab-keystroke-accepts-autosuggestions",
                keystroke = *view.autosuggestions_keystroke
            )),
            TabBehavior::Autosuggestions
                if *input_settings.completions_open_while_typing.value() =>
            {
                if view.completions_keystroke.is_empty() {
                    Some(tr!("settings-features-completions-open-as-you-type"))
                } else {
                    Some(tr!(
                        "settings-features-completions-open-as-you-type-or",
                        keystroke = *view.completions_keystroke
                    ))
                }
            }
            TabBehavior::Autosuggestions if view.completions_keystroke.is_empty() => {
                Some(tr!("settings-features-completion-menu-unbound"))
            }
            TabBehavior::Autosuggestions => Some(tr!(
                "settings-features-keystroke-opens-completion-menu",
                keystroke = *view.completions_keystroke
            )),
    ...
    fn render(
        ...
        let mut tab_key_span = Flex::row()
            ...
            .with_child(
                appearance
                    .ui_builder()
                    .span(tr!("settings-features-tab-key-behavior"))
                    .with_style(UiComponentStyles {
    ...
    fn render(
        ...
        add_setting(
            ...
            || {
                render_dropdown_item(
                    appearance,
                    &tr!("settings-features-ctrl-tab-behavior"),
                    None,
                    None,
                    LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MouseReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-enable-mouse-reporting"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for ScrollReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-enable-scroll-reporting"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-enable-focus-reporting"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AudibleBellWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-use-audible-bell"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SmartSelectWidget {
    fn render_word_char_config(
        ...
        Flex::column()
            .with_child(
                ui_builder
                    .label(tr!("settings-features-characters-part-of-word"))
                    .with_style(UiComponentStyles {
                        margin: Some(Coords {
                            top: 10.0,
                            bottom: 5.0,
...
impl SettingsWidget for SmartSelectWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column();
        column.add_child(render_body_item::<FeaturesPageAction>(
            tr!("settings-features-double-click-smart-selection"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for ShowTerminalZeroStateBlockWidget {
    ...
    fn render(
        ...
        let terminal_settings = TerminalSettings::as_ref(app);
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-help-block-new-sessions"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CopyOnSelectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-copy-on-select"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for NewTabPlacementWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            &tr!("settings-features-new-tab-placement"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DefaultSessionModeWidget {
    ...
    fn render(
        ...
        let label = render_dropdown_item_label(
            tr!("settings-features-default-mode-for-new-sessions"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for WorkflowsInCommandSearch {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-show-global-workflows"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for LinuxSelectionClipboardWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            tr!("settings-features-linux-selection-clipboard"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(
                    tr!("settings-features-linux-selection-clipboard-tooltip"),
                ),
            }),
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for GPUWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<FeaturesPageAction>(
            tr!("settings-features-prefer-low-power-gpu"),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if view.gpu_power_preference_changed {
            ...
            col.add_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .wrappable_text(&tr!("settings-features-changes-apply-new-windows"), true)
                        .with_style(UiComponentStyles {
...
impl SettingsWidget for WindowSystemWidget {
    ...
    fn render(
        ...
        children.add_child(render_body_item::<FeaturesPageAction>(
            tr!("settings-features-use-wayland"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(tr!("settings-features-wayland-tooltip")),
            }),
            LocalOnlyIconState::for_setting(
        ...
        let mut secondary_text = tr!("settings-features-wayland-description");
        if view.force_x11_changed {
            secondary_text.push_str(&format!("\n\n{}", tr!("settings-features-restart-warp-changes")));
        }
...
impl SettingsWidget for GraphicsBackendWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            &tr!("settings-features-preferred-graphics-backend"),
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        if let Some(window) = app.windows().platform_window(view.window_id) {
            ...
            col.add_child(
                appearance
                    .ui_builder()
                    .wrappable_text(tr!("settings-features-current-backend", backend = backend.to_label()), true)
                    .with_style(UiComponentStyles {
                        font_color: Some(theme.sub_text_color(theme.background()).into_solid()),
                        ..Default::default()
                    })
