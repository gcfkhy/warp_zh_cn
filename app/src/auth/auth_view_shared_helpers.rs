    ...
    A: Action + Clone,
{
    ...
    let button = ui_builder
        ...
        .with_centered_text_label(tr!("button-learn-more"))
        .build()
    ...
    A: Action + Clone,
{
    ...
    let paragraph_1 = tr!("auth-offline-paragraph-1");
    let paragraph_2 = tr!("auth-offline-paragraph-2");
    let paragraph_3 = tr!("auth-offline-paragraph-3");
...
pub fn render_privacy_settings_toggles<A: Action + Clone + 'static>(
    ...
    let telemetry_toggle = Flex::row()
        ...
        .with_child(
            Shrinkable::new(
                1.,
                render_privacy_settings_section_header(tr!("auth-privacy-telemetry-title"), appearance).finish(),
            )
            .finish(),
        )
        .with_child(
    ...
    let telemetry_description = render_description(
        appearance,
        tr!("auth-privacy-telemetry-desc"),
    );
    ...
    let crash_reporting_toggle = Flex::row()
        ...
        .with_child(
            Shrinkable::new(
                1.,
                render_privacy_settings_section_header(tr!("auth-privacy-crash-title"), appearance).finish(),
            )
            .finish(),
        )
        .with_child(
    ...
    let cloud_conversation_storage_description = render_description(
        ...
        if PrivacySettings::as_ref(app).is_cloud_conversation_storage_enabled {
            tr!("auth-privacy-cloud-enabled-desc")
        } else {
            tr!("auth-privacy-cloud-disabled-desc")
        },
    );
