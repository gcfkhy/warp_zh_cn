...
impl AgentSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            .ui_builder()
            .paragraph(&tr!("onboarding-customize-agent"))
    ...
    fn render_model_section(
        ...
        let header = self.render_section_header(&tr!("onboarding-default-model"), appearance);
    ...
    fn render_model_row(
        ...
        let hoverable_body = Hoverable::new(mouse_state, move |_| {
            ...
            let make_pill = |label: &str| -> Box<dyn Element> {
            ...
            let trailing: Box<dyn Element> = if is_default {
                make_pill(&tr!("onboarding-recommended"))
            } else if requires_upgrade {
                make_pill(&tr!("onboarding-premium"))
            } else {
                Empty::new().finish()
            };
    ...
    fn render_autonomy_workspace_enforced(&self, appearance: &Appearance) -> Box<dyn Element> {
        let header = self.render_section_header(&tr!("onboarding-autonomy"), appearance);
        ...
        let title_el = Text::new(tr!("onboarding-set-by-workspace"), ui_font_family, 14.0)
            .with_color(title_color)
            .with_style(Properties {
                weight: Weight::Normal,
                ..Default::default()
        ...
        let subtitle_el = Text::new(
            &tr!("onboarding-autonomy-workspace"),
            ui_font_family,
            12.0,
        )
    ...
    fn render_autonomy_section(
        ...
        let autonomy_options: [(AgentAutonomy, String, String, MouseStateHandle); 3] = [
            (
                AgentAutonomy::Full,
                tr!("onboarding-autonomy-full"),
                tr!("onboarding-autonomy-full-desc"),
                self.autonomy_full_mouse_state.clone(),
            ),
            (
                AgentAutonomy::Partial,
                tr!("onboarding-autonomy-partial"),
                tr!("onboarding-autonomy-partial-desc"),
                self.autonomy_partial_mouse_state.clone(),
            ),
            (
                AgentAutonomy::None,
                tr!("onboarding-autonomy-none"),
                tr!("onboarding-autonomy-none-desc"),
    ...
    fn render_disable_oz_section(
        ...
        let label = Text::new(tr!("onboarding-disable-agent"), appearance.ui_font_family(), 14.0)
            .with_color(internal_colors::text_sub(theme, background_for_text))
            .with_style(Properties {
                weight: Weight::Normal,
                ..Default::default()
    ...
    fn render_upgrade_banner(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let subtitle = Text::new(
            &tr!("onboarding-premium-require-paid"),
            ui_font_family,
            12.0,
        )
        .with_color(internal_colors::text_sub(theme, background_for_text))
        ...
        let upgrade_button = self.upgrade_button.render(
            appearance,
            button::Params {
                content: button::Content::Label(tr!("button-upgrade")),
    ...
    fn render_auth_prompt_bar(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let text_row = Flex::row()
            ...
            .with_child(
                Container::new(
                    ui_builder
                        .span(&format!("{} ", tr!("auth-browser-hint-1")))
            ...
            .with_child(
                ui_builder
                    .span(&format!("{} ", tr!("auth-browser-hint-2")))
                    .with_style(text_styles)
                    .build()
                    .finish(),
            )
            ...
            .with_child(
                ui_builder
                    .span(&tr!("onboarding-paste-token-suffix"))
                    .with_style(text_styles)
                    .build()
                    .finish(),
            )
    ...
    fn render_plan_activated_toast(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let text = ui_builder
            .span(&tr!("onboarding-plan-activated"))
            .with_style(UiComponentStyles {
                font_color: Some(text_color),
                font_size: Some(FONT_SIZE),
                font_weight: Some(Weight::Medium),
