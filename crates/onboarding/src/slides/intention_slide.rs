...
impl IntentionSlide {
    ...
    fn render_agent_card(
        ...
        let header_row = {
            let label = appearance
                .ui_builder()
                .paragraph(&tr!("onboarding-build-faster-ai"))
                .with_style(UiComponentStyles {
                    font_size: Some(16.),
    ...
    fn render_terminal_card(
        ...
        let label = appearance
            .ui_builder()
            .paragraph(&tr!("onboarding-just-terminal"))
            .with_style(UiComponentStyles {
                font_size: Some(16.),
                font_weight: Some(Weight::Semibold),
        ...
        let badge = {
            let badge_text = appearance
                .ui_builder()
                .paragraph(&tr!("onboarding-no-ai-features"))
                .with_style(UiComponentStyles {
                    font_size: Some(12.),
                    font_weight: Some(Weight::Semibold),
                    font_color: Some(text_color),
